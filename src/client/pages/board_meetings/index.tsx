      ...
      >
        ...
        >
          {financialYears.map((fy, index) => (
            <StyledTreeItem nodeId={fy} label={fy}>
              <TreeNodeComponent financialYear={fy} />
            </StyledTreeItem>
          ))}
        </TreeView>
      </Box>
...
const TreeNodeComponent: React.FC<NodeProps> = (props: NodeProps) => {
  ...
  return (
    <>
      {["Q1", "Q2", "Q3", "Q4"].map((q) => (
        <StyledTreeItem nodeId={q} label={q + " Meetings"}>
          {meetings
                ...
                label={
                  <>
                    ...
                    >
                      <Typography>
                        {m.title}{" "}
                        <Chip label={moment(m.startTime).format("lll")} />
                      </Typography>
                    </Link>
                  </>
                }
